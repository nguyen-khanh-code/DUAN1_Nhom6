                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="cart-update-option d-block d-md-flex justify-content-between">
                                <div class="apply-coupon-wrapper">
                                    <form action="<?= BASE_URL .'?act=ma-giam-gia' ?>" method="post" class=" d-block d-md-flex"> 
                                ...
                                <div class="cart-update">
                                    <a href="<?php echo BASE_URL . '?act=gio-hang' ?>"  class="btn_cap_nhat_gio_hang btn btn-sqr">Cập nhập giỏ hàng</a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 ml-auto">
                            ...
                            <div class="cart-calculator-wrapper">
                                ...
                                <a href="<?= BASE_URL . '?act=thanh-toan' ?><?= isset($maGiam) ? '&ma_id=' . ($maGiam[0]['gia_tri_giam'] ?? '') : '' ?>" class="btn btn-sqr d-block">Thanh toán</a>
...
jQuery(document).ready(function($) {
    ...
    function updateCart(input) {
        ...
        $.ajax({
            url: '<?php echo BASE_URL . '?act=update-Cart' ?>', // The PHP file that handles the update
            type: 'POST',
            data: {
    ...
    function deleteSp(id) {
        $.ajax({
            url: '<?php echo BASE_URL . '?act=delete-cart' ?>', // The PHP file that handles the update
            type: 'POST',
            data: {
                product_id: id
            },

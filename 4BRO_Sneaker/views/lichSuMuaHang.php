                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="?act=gio-hang">Giỏ hàng</a></li>
                                    <li class="breadcrumb-item"><a href="?act=thanh-toan">Thanh toán</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach($donHang as $don): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= BASE_URL . '?act=chi-tiet-mua-hang&id_don_hang=' . $don['id'] ?>"><button class="btn btn-sqr">Chi tiết</button></a>
                                                    <?php 
                                                    if($don['trang_thai_id']==1):?>
                                                    <a href="<?= BASE_URL . '?act=huy-don-hang&id_don_hang=' . $don['id'] ?>" onclick="return confirm('Bạn có chắc muốn hủy đơn hàng không?')" ><button class="btn btn-sqr">Hủy</button></a>

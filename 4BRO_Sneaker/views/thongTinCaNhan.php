            ...
            <div class="col-lg-12">
                <div class="login-reg-form-wrap">
                    ...
                    <form action="<?= BASE_URL . '?act=update-profile' ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="single-input-item"> <?php if ($user['anh_dai_dien']): ?> <img src="<?='uploads/'. $user['anh_dai_dien'] ?>" alt="Avatar" style="max-width: 150px; display: block; margin-bottom: 10px;">
                             <?php endif; ?>

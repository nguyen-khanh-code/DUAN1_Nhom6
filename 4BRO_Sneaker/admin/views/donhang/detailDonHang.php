          ...
          foreach ($listTrangThai as $trangThai) {
            if ($trangThai['id'] == $donHang['trang_thai_id']) {
              ...
              <?php if ($nextTrangThai['id'] <= 7) { ?>
                <a href="<?= BASE_URL_ADMIN . '?act=cap-nhat-don-hang&id_don_hang=' . $donHang['id'] ?>"
                ...
                <?php if ($donHang['trang_thai_id'] == 1) { ?>
                  <a href="<?= BASE_URL_ADMIN . '?act=huy-don-hang&id_don_hang=' . $donHang['id'] ?>"

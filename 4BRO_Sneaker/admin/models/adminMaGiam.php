...
class AdminMaGiam
{
    ...
    {
        try {
            $sql = "INSERT INTO ma_giam_gias(ma, gia_tri_giam, ngay_tao) VALUES (:ma,:gia_tri_giam, :ngay_tao)";
            $stmt = $this->conn->prepare($sql);
            $stmt->execute(
                [
    ...
    {
        try {
            $sql = "UPDATE ma_giam_gias SET ma = :ma,gia_tri_giam = :gia_tri_giam WHERE id = :id";
            $stmt = $this->conn->prepare($sql);
            $stmt->execute(
                [
